...
if((i < len)){
var k = (ks[i]);
var G__13454 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__13455 = (i + (1));
m = G__13454;
i = G__13455;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__13459 = c;
var G__13459__$1 = (((G__13459 == null))?null:G__13459.prototype);
if((G__13459__$1 == null)){
return null;
} else {
return (G__13459__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__13463 = c;
var G__13463__$1 = (((G__13463 == null))?null:G__13463.prototype);
if((G__13463__$1 == null)){
return null;
} else {
return (G__13463__$1["render"]);
}
})()));
});
...
return (function() { 
var G__13467__delegate = function (args){
...
while (G__13468__i < G__13468__a.length) {G__13468__a[G__13468__i] = arguments[G__13468__i + 0]; ++G__13468__i;}
  args = new cljs.core.IndexedSeq(G__13468__a,0);
} 
return G__13467__delegate.call(this,args);};
G__13467.cljs$lang$maxFixedArity = 0;
G__13467.cljs$lang$applyTo = (function (arglist__13469){
...
var _STAR_current_component_STAR_13472 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_13472;
}});
...
var G__13476 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__13476) {
...
var or__6739__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__13478_13480 = (c["cljsRatom"]);
if((G__13478_13480 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__13478_13480);
}
...
if(cljs.core.truth_((function (){var and__6727__auto__ = wrap;
if(cljs.core.truth_(and__6727__auto__)){
return f;
} else {
...
if(((1) === cljs.core.count.call(null,renders_13483))){
} else {
...
if(cljs.core.ifn_QMARK_.call(null,render_fun_13484)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun_13484))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__6739__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6739__auto__)){
return or__6739__auto__;
} else {
...
var render_fun__$1 = (function (){var or__6739__auto__ = render_fun;
if(cljs.core.truth_(or__6739__auto__)){
return or__6739__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__6739__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6739__auto__)){
return or__6739__auto__;
} else {
...
var name__$1 = (function (){var G__13482 = name;
switch (G__13482) {
case "":
...
var G__13487 = o;
(G__13487[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__13493 = (function (){var or__6739__auto__ = (function (){var G__13495 = c;
if((G__13495 == null)){
return null;
} else {
return (G__13495["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6739__auto__)){
return or__6739__auto__;
...
return (G__13493["_currentElement"]);
}
})();
var name = (function (){var G__13496 = elem;
var G__13496__$1 = (((G__13496 == null))?null:(G__13496["type"]));
if((G__13496__$1 == null)){
return null;
} else {
return (G__13496__$1["displayName"]);
}
})();
var path = (function (){var G__13497 = elem;
var G__13497__$1 = (((G__13497 == null))?null:(G__13497["_owner"]));
var G__13497__$2 = (((G__13497__$1 == null))?null:reagent$impl$component$component_path.call(null,G__13497__$1));
if((G__13497__$2 == null)){
return null;
} else {
return [cljs.core.str(G__13497__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__6739__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__6739__auto__)){
return or__6739__auto__;
} else {
var G__13499 = c;
var G__13499__$1 = (((G__13499 == null))?null:G__13499.constructor);
if((G__13499__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__13499__$1);
}
}
})();
...
var temp__6371__auto__ = reagent.impl.component.cached_react_class.call(null,tag);
if((temp__6371__auto__ == null)){
return reagent.impl.component.fn_to_class.call(null,tag);
} else {
var cached_class = temp__6371__auto__;
return cached_class;
}
});
...
//# sourceMappingURL=component.js.map?rel=1467727632388