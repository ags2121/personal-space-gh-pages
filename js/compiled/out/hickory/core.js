...
var x__24318__auto__ = (((this$ == null))?null:this$);
var m__24319__auto__ = (hickory.core.as_hiccup[goog.typeOf(x__24318__auto__)]);
if(!((m__24319__auto__ == null))){
return m__24319__auto__.call(null,this$);
} else {
var m__24319__auto____$1 = (hickory.core.as_hiccup["_"]);
if(!((m__24319__auto____$1 == null))){
return m__24319__auto____$1.call(null,this$);
} else {
...
var x__24318__auto__ = (((this$ == null))?null:this$);
var m__24319__auto__ = (hickory.core.as_hickory[goog.typeOf(x__24318__auto__)]);
if(!((m__24319__auto__ == null))){
return m__24319__auto__.call(null,this$);
} else {
var m__24319__auto____$1 = (hickory.core.as_hickory["_"]);
if(!((m__24319__auto____$1 == null))){
return m__24319__auto____$1.call(null,this$);
} else {
...
var expr__24969 = (this$["nodeType"]);
if(cljs.core.truth_(pred__24968.call(null,hickory.core.Attribute,expr__24969))){
...
var pred__24971 = cljs.core._EQ_;
var expr__24972 = (this$["nodeType"]);
if(cljs.core.truth_(pred__24971.call(null,hickory.core.Attribute,expr__24972))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword.call(null,(this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_(pred__24971.call(null,hickory.core.Comment,expr__24972))){
...
if(cljs.core.truth_(pred__24971.call(null,hickory.core.Document,expr__24972))){
...
if(cljs.core.truth_(pred__24971.call(null,hickory.core.DocumentType,expr__24972))){
...
if(cljs.core.truth_(pred__24971.call(null,hickory.core.Element,expr__24972))){
...
if(cljs.core.truth_(pred__24971.call(null,hickory.core.Text,expr__24972))){
return (this$["wholeText"]);
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__24972)].join('')));
}
}
}
}
...
var temp__6369__auto__ = cljs.core.second.call(null,(function (){var or__23605__auto__ = cljs.core.re_find.call(null,/<!DOCTYPE ([^>]*)>/,s);
...
var doctype = temp__6369__auto__;
...
var temp__6369__auto___24974 = cljs.core.first.call(null,(doc["head"]["childNodes"]));
if(cljs.core.truth_(temp__6369__auto___24974)){
var title_el_24975 = temp__6369__auto___24974;
if(cljs.core.empty_QMARK_.call(null,(title_el_24975["text"]))){
hickory.core.remove_el.call(null,title_el_24975);
} else {
}
} else {
}
...
var or__23605__auto__ = hickory.core.parse_dom_with_domparser.call(null,s);
if(cljs.core.truth_(or__23605__auto__)){
return or__23605__auto__;
} else {
...
//# sourceMappingURL=core.js.map?rel=1467729570355