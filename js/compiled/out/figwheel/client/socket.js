...
}catch (e28612){if((e28612 instanceof Error)){
var e = e28612;
return null;
} else {
throw e28612;
...
var and__23591__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__23591__auto__){
var and__23591__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__23591__auto____$1)){
var and__23591__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__28613){
...
var opts = map__28616__$1;
var retry_count = cljs.core.get.call(null,map__28616__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__28616__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__28616__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__28616__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
var temp__6367__auto__ = figwheel.client.socket.get_websocket_imp.call(null);
if(cljs.core.truth_(temp__6367__auto__)){
var WebSocket = temp__6367__auto__;
...
socket.onmessage = ((function (url,socket,WebSocket,temp__6367__auto__,map__28616,map__28616__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (msg_str){
var temp__6369__auto__ = cljs.reader.read_string.call(null,msg_str.data);
if(cljs.core.truth_(temp__6369__auto__)){
var msg = temp__6369__auto__;
...
});})(url,socket,WebSocket,temp__6367__auto__,map__28616,map__28616__$1,opts,retry_count,retried_count,websocket_url,build_id))
;

socket.onopen = ((function (url,socket,WebSocket,temp__6367__auto__,map__28616,map__28616__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__6367__auto__,map__28616,map__28616__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
var retried_count__$1 = (function (){var or__23603__auto__ = retried_count;
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__6367__auto__,map__28616,map__28616__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__6367__auto__,map__28616,map__28616__$1,opts,retry_count,retried_count,websocket_url,build_id))
,(function (){var x__23943__auto__ = (10000);
var y__23944__auto__ = ((2000) + ((500) * retried_count__$1));
...
socket.onerror = ((function (url,socket,WebSocket,temp__6367__auto__,map__28616,map__28616__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1467728154648